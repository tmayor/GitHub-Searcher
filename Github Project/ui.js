class UI {
    ...
    // lets create a method called Show Profile
    displayProfile(user){
        ...
        <h3 class="page-heading mb-3">Lastest Respository</h3>
        <div id="repos"></div> 
    ...
    showRepos(repos){
        ...
        repos.forEach(function(repo){
            output += ` <div class="card card-body mt-2">
                            <div class="row">
                                <div class="col-md-6">
    ...
    showAlert(message, className){
        ...
        // Insert, We want to get a Parent
